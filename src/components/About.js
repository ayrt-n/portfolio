  ...
  return (
    <div>
      <Section>
        ...
        <LineBreak />
        <Text>Hi! My name is Ayrton Parkinson. I am a full stack software engineer. I am currently pursuing my Bachelor of Computer Science at Carleton University.</Text>
        <Text>While originally going to school for economics and finance, I started coding as a hobby through 2021 and from that point on, I was hooked. Since then I have been learning and building every opportunity I get. For some examples of recent work, see <span className="text-green font-bold">Projects.js</span>.</Text>
