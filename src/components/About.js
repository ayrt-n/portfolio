  ...
  return (
    <div>
      <Section>
        ...
        <Text>For information on how to reach out, see <span className="font-bold text-yellow">Contact.md</span>.</Text>
      </Section>
