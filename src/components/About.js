  ...
  return (
    <div>
      <Section>
        ...
        <LineBreak />
        <Text>Hi! My name is Ayrton Parkinson. I am a self-taught full stack software engineer from Ontario, Canada.</Text>
        <Text>While originally going to school for economics and finance, I started coding as a hobby through 2021 and from that point on, I was hooked. Since then I have been learning and building every opportunity I get. For some examples of recent work, see <TabLink tab={portfolio}>Portfolio.js</TabLink>.</Text>
        ...
        <Text>For information on how to reach out, see <TabLink tab={contact}>Contact.md</TabLink>.</Text>
      </Section>
